# Generated by Powerlevel10k configuration wizard on 2026-02-03 at 10:34 -05.
...
# angled separators, blurred heads, sharp tails, 2 lines, dotted, right frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    my_git_info             # lightweight git branch via system git
    # =========================[ Line #2 ]=========================
    newline                 # \n
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      (( $#branch > 48 )) && branch[20,-20]="…"  # <-- this line
  ...
  # Lightweight git branch segment using system git (supports reftable).
  # gitstatusd's bundled libgit2 cannot read reftable refs, so we bypass
  # it entirely and call the system git binary which is fast (~18ms).
  function prompt_my_git_info() {
    local branch
    branch=$(git symbolic-ref --short HEAD 2>/dev/null) || \
      branch=$(git rev-parse --short HEAD 2>/dev/null) || \
      return
    p10k segment -b 2 -f 0 -i $'\uF126 ' -t "${branch}"
  }

  function instant_prompt_my_git_info() {
    prompt_my_git_info
  }
